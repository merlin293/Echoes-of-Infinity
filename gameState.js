...
function initializeDefaultGameStateVariables() {
    ...
    gameState.effectiveClickDamage = gameState.baseClickDamage; 
    ...
    gameState.effectiveCritChance = gameState.baseCritChance; 
    ...
    if (typeof allResearchProjects !== 'undefined') { 
        ...
        console.error("allResearchProjects is not defined in config.js. Research progress will not be initialized correctly.");
    }
    ...
    if (typeof allEssences !== 'undefined') { 
        ...
        console.error("allEssences is not defined in config.js. Essences progress will not be initialized correctly.");
    }
    ...
    if (typeof allCompanions !== 'undefined') {
        for (const companionId in allCompanions) {
            if (allCompanions.hasOwnProperty(companionId) && allCompanions[companionId].skillTree) {
