...
function renderEquipmentUI() {
    ...
    // console.log("renderEquipmentUI called. Current Tier Index:", gameState.currentTierIndex);
    ...
    equipmentSlots.forEach(slot => { 
        ...
        infoDiv.innerHTML = `
            ...
            <div>
                <span class="equipment-name">${itemNamesCzech[slot] || slot}</span>
